...
const HomeComponent = ({ details = {}, activities }) => {
  ...
  const handleOnToggleHelp = useCallback(
    (data) => {
      setShowHelp(data);
    },
    [setShowHelp]
    ...
    <div className="home-main-container">
      <div className="home-header-container">
        <div className="app-name-container">
          <span className="app-display-name">{content.BREAKER}</span>
          <br />
        ...
        <div className="header-icon-container">
          ...
          <div className="header-icon-text-container">
            <p className="coin-number">{balance}</p>
        ...
        {activities &&
          activities.map((activity) => (
            <div className="activity-card">
              {activity.song_update ? (
                <svg className="activity-play-icon">
                  <Play />
                </svg>
              ) : (
              ...
              <span className="time-text">
                {timeDiffCalc(moment(activity.created_on), new Date())}
              </span>
            </div>
          ))}
      </div>
