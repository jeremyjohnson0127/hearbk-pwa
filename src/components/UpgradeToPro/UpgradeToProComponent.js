        ...
        <div className="upgraePro-main-container">
            ...
            <div className="membership-main-container">
                ...
                <div className="rating-container-1">
                    {selectedPlan === 1 && <><span className="rating-amount-text">$99/</span><small className="listner-text">{content.YEAR}</small></>}
                    {selectedPlan === 2 && <><span className="rating-amount-text">$14.99/</span><small className="listner-text">{content.MONTH}</small></>}
                </div>
            </div>
