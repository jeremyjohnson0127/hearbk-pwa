...
const RatingContainer = ({ tracks, handleSelectedFeedback }) => {
  return (
    <div className="rating-main-container">
      ...
      <div className="rating-container">
        ...
        >
          <small className="plan-text">{content.PREMIERE}</small>
          <div>
            <span>
              <b>100</b>
            </span>{" "}
            <small className="listner-text">{content.LISTENERS}</small>
          </div>
