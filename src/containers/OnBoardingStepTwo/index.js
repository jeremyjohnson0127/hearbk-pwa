...
import OnboardingComponent from "../../components/OnBoardingStepTwo/OnboardingComponent";
import { getUserDetails } from "../../state/actions/userActions";
import history from "../../history";

class OnBoardingStepTwoContainer extends React.Component {
  componentDidMount() {
    const { getUserDetailsDispatchAction } = this.props;
  ...
  render() {
    return (
      <OnboardingComponent
        ...
        handleClickGetStarted={this.handleClickGetStarted}
      />
    );
  }
}
